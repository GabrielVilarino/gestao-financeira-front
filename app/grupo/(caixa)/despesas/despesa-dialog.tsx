...
const despesaFormSchema = z.object({
  id_categoria: z.number({ error: "Categoria Ã© obrigatÃ³ria" }).int().positive("Categoria invÃ¡lida"),
  id_subcategoria: z.number().int().positive("Subcategoria invÃ¡lida").optional(),
  descricao: z.string().min(1, "DescriÃ§Ã£o Ã© obrigatÃ³ria"),
  observacao: z.string().optional(),
  valor: z.number({ error: "Valor Ã© obrigatÃ³rio" }).positive("Valor deve ser positivo"),
  competencia: z.string().min(1, "CompetÃªncia Ã© obrigatÃ³ria"),
...
const recorrenciaFormSchema = z.object({
  ...
  frequencia: z.enum(["DIARIA", "SEMANAL", "MENSAL", "ANUAL"], { error: "FrequÃªncia Ã© obrigatÃ³ria" }),
  intervalo: z.number({ error: "Intervalo Ã© obrigatÃ³rio" }).int().positive("Intervalo deve ser positivo"),
